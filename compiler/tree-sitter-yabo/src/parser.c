...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(108)] = 4685,
  [SMALL_STATE(109)] = 4704,
  [SMALL_STATE(110)] = 4724,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [33] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_constraint_expression, 3, .production_id = 3),
  [35] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_constraint_expression, 3, .production_id = 3),
  [37] = {.entry = {.count = 1, .reusable = true}}, SHIFT(100),
  [39] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_char_literal, 3),
  [41] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_char_literal, 3),
